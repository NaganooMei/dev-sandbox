...
![CE shared Host memory absolute WallBW](images/ascend_h2d_glm512_ce_one_share_wallbw.png)

### 3.2 FFTS · 共享 Host 内存

![FFTS shared Host memory absolute WallBW](images/ascend_h2d_glm512_ffts_one_share_wallbw.png)

### 3.3 CE · 非共享 Host 内存

![CE non-shared Host memory absolute WallBW](images/ascend_h2d_glm512_ce_all_wallbw.png)

### 3.4 FFTS · 非共享 Host 内存

![FFTS non-shared Host memory absolute WallBW](images/ascend_h2d_glm512_ffts_all_wallbw.png)
